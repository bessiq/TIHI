...
events.listen('jei.information', function (event) {
    ...
    //event.add('rftoolsbase:dimensionalshard_overworld', ['Pretty much non-existant. You might get lucky in unliving bodies of water.'])
    //event.add('rftoolsbase:dimensionalshard_nether', ['Rarely seen near the impenetrable ceiling of The Nether.'])
...
events.listen('jei.add.items', function (event) {
    ...
    //event.add('appliedenergistics2:facade', {item:"minecraft:stone"})
})
