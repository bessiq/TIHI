...
<recipetype:mekanism:smelting>.removeRecipe(<item:immersiveengineering:ingot_electrum>);

craftingTable.addShapeless("electrum_block_sm_to_ie", <item:immersiveengineering:storage_electrum>,
 [<item:silents_mechanisms:electrum_block>]);
craftingTable.addShapeless("electrum_block_ie_to_sm", <item:silents_mechanisms:electrum_block>,
