...
Last README file update: Sat Nov 21 10:49:46 EST 2020
...
command
command.addtrait
command.addtrait.auto-smelt
command.addtrait.blinding
command.addtrait.blood_hunger
command.addtrait.blood_thirst
command.addtrait.bouncier
command.addtrait.bouncy
command.addtrait.cloud_walker
command.addtrait.deep_breathing
command.addtrait.double_webbed
command.addtrait.explosive
command.addtrait.filling
command.addtrait.fire_resistant
command.addtrait.floating
command.addtrait.fortified
command.addtrait.giant_slayer
command.addtrait.glittering
command.addtrait.hastey
command.addtrait.hastier
command.addtrait.infinity_edge
command.addtrait.insightful
command.addtrait.lucky
command.addtrait.more_fire_resistant
command.addtrait.more_resistant
command.addtrait.phasing
command.addtrait.poisonous
command.addtrait.regenerating
command.addtrait.resistant
command.addtrait.soul_searching
command.addtrait.speedier
command.addtrait.speedy
command.addtrait.strong
command.addtrait.stronger
command.addtrait.super_lucky
command.addtrait.titan_slayer
command.addtrait.very_poisonous
command.addtrait.very_weakening
command.addtrait.very_withering
command.addtrait.weakening
command.addtrait.webbed
command.addtrait.withering
command.advancement
...
command.deltrait
command.deltrait.auto-smelt
command.deltrait.blinding
command.deltrait.blood_hunger
command.deltrait.blood_thirst
command.deltrait.bouncier
command.deltrait.bouncy
command.deltrait.cloud_walker
command.deltrait.deep_breathing
command.deltrait.double_webbed
command.deltrait.explosive
command.deltrait.filling
command.deltrait.fire_resistant
command.deltrait.floating
command.deltrait.fortified
command.deltrait.giant_slayer
command.deltrait.glittering
command.deltrait.hastey
command.deltrait.hastier
command.deltrait.infinity_edge
command.deltrait.insightful
command.deltrait.lucky
command.deltrait.more_fire_resistant
command.deltrait.more_resistant
command.deltrait.phasing
command.deltrait.poisonous
command.deltrait.regenerating
command.deltrait.resistant
command.deltrait.soul_searching
command.deltrait.speedier
command.deltrait.speedy
command.deltrait.strong
command.deltrait.stronger
command.deltrait.super_lucky
command.deltrait.titan_slayer
command.deltrait.very_poisonous
command.deltrait.very_weakening
command.deltrait.very_withering
command.deltrait.weakening
command.deltrait.webbed
command.deltrait.withering
command.difficulty
...
command.locate.teletubbies:dome
